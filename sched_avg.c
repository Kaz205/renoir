...
(0xb3a+4408-0x1c02);unsigned int sysctl_sched_coloc_busy_hyst=39000000;unsigned 
int sysctl_sched_coloc_busy_hyst_max_ms=5000;static DEFINE_PER_CPU(atomic64_t,
WALT739b44b3f3)=ATOMIC64_INIT((0x960+708-0xc24));static DEFINE_PER_CPU(u64,
WALT701fb8f8ec);
#define WALTcc368a061f		(0xeed+2639-0x192d)
...
WALTde16cdc0f2,WALT8f9ab72eb9);BUG_ON((s64)WALT1f1d98d140<(0xa01+2225-0x12b2));
...
(0xc7+7492-0x1da7)),WALT65b7325c24);WALT346aee5ac3=per_cpu(WALT95bc2af379,
WALT8f9ab72eb9);WALT346aee5ac3+=walt_big_tasks(WALT8f9ab72eb9)*WALT1f1d98d140;
WALT346aee5ac3=div64_u64((WALT346aee5ac3*(0xe5c+4281-0x1eb1)),WALT65b7325c24);
WALTf0f82ef4d0[WALT8f9ab72eb9].nr=(int)div64_u64((WALT42db3f0aea+WALTcc368a061f)
,(0xcd3+6165-0x2484));WALTf0f82ef4d0[WALT8f9ab72eb9].nr_misfit=(int)div64_u64((
WALT346aee5ac3+WALTcc368a061f),(0x115d+3710-0x1f77));WALTf0f82ef4d0[
...
WALT5c03c65a13,WALT8f9ab72eb9)=(0xc32+6204-0x246e);per_cpu(WALT95bc2af379,
WALT8f9ab72eb9)=(0x2d9+6909-0x1dd6);per_cpu(nr_max,WALT8f9ab72eb9)=per_cpu(nr,
...
sysctl_sched_busy_hyst_enable_cpus)?sysctl_sched_busy_hyst:(0x1150+4953-0x24a9);
WALTc11d8dcd20=((BIT(WALT8f9ab72eb9)&sysctl_sched_coloc_busy_hyst_enable_cpus)&&
WALTe5f9c419f8)?sysctl_sched_coloc_busy_hyst:(0x1b37+647-0x1dbe);per_cpu(
WALT701fb8f8ec,WALT8f9ab72eb9)=max(WALT86ea06dbda,WALTc11d8dcd20);}}
#define WALT8dd50955b9		(0x616+1618-0xc65)
#define WALTed8d29ed55	(0x407+378-0x577)
...
WALT8f9ab72eb9);BUG_ON((s64)WALT1f1d98d140<(0x109b+4643-0x22be));per_cpu(
...
per_cpu(nr,WALT8f9ab72eb9)<(0x1700+1827-0x1e23));if(per_cpu(nr,WALT8f9ab72eb9)>
...
WALTb0b0149580;WALT517f9bdd84=div64_ul((WALTb0b0149580*(0x1fa8+560-0x2174)),
...
WALT09c73f1899)return WALT09c73f1899-WALT2c53bb3f34;return(0x12eb+2656-0x1d4b);}
